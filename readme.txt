...
This program requires Nodemailer and node.js in order to function. Install node.js on your computer, then install Nodemailer via npm in the working directory of this program. Then, navigate via the terminal to the folder where this is located and edit santabot.js as you see fit in order to add people's names and e-mail addresses. When you are finished, run node santabot.js to execute the random allocation process.
